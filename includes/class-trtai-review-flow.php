...
class Trtai_Review_Flow {
    ...
    public function handle_generation() {
        ...
        $instruction = 'Return strict JSON with keys: title, slug, meta_description, focus_keyphrase, excerpt, content_html, pros (array), cons (array), social_captions (object with threads, facebook, generic). Write in HTML within content_html with H2/H3 structure, keeping the JSON shape and HTML layout intact. Use a confident, conversational editor voice with varied sentence lengths. Open with a strong intro that explains why the product matters. Add descriptive H2/H3 labels and cover design, performance, features, software, battery, price/value, and verdict sections. Keep JSON valid. Match the confident, conversational tech-journalism tone of The Verge, Engadget, and Android Police.';
